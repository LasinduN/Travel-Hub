        ...
        <div className="font-barlows ">
          ...
          >
            <p className="md:text-left text-justify ">
              ...
              Currently, we operate 15 buses that serve our universities.
            ...
            <p className="md:text-left text-justify">
              Please be aware that any violations or improper behavior.We are committed to providing you
